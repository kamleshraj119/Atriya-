					...
					<div class="col-md-6 col-sm-6 job-item internship">
						<div class="content-wrap">
							...
							<div class="company-info internship" style="border-top:1px solid #f8f8f8">
								...
								<a href="candidate.php?action=readarticles&id={$r.article_id}"  class="read-more">
								<div class="text">
									Read More
								</div>
