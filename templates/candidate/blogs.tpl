...
<script>
	function getBlogData() {
		...
		var callback = function(res) {
			...
			if (data.length > 0) {
				for (var i = 0; i < data.length; i++) {
					...
					parent.className = "col-lg-4 col-md-4 col-sm-6 col-xs-12 job-item internship";
					...
					div2.innerHTML = div2.innerHTML + " <a href='candidate.php?action=readblog&id="+data[i].blog_id+"' class='read-more'><div class='text'>Read More</div><div class='right-arrow'><i class='fa fa-angle-right'></i></div></a>";
		...
		var parameter = "";
		url += "?page_no=" + pageNumber + "&page_size=" + pageSize +"&role=200"+ "&REQUEST=GET_BLOG_PAGE";
