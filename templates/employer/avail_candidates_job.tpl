...
<div class="col-md-12 resp-work-exp" style="margin-top:20px;">
	<h4>AVAILABLE CANDIDATES FOR JOB</h4>
				...
				<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-xs-12 col-mine-def" >
					<div class="content-wrap">
						<div class="company-logo valign-wrap">
							<div class="valign-middle valign-middle-mine">
								{if $r.profile_pic!=""}
								<img src="http://skillchamps.in/admin/images/candidate/{$r.cid}/{$r.profile_pic}" width="81px" height="82px" alt="">
								{else}
									...
									<div style="margin: 10px 0px 10px 0px;" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="row exp-btn-mine">
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
												<div class="row">
													<a href="javascript:void(0);" data-toggle="modal"  onclick="shortlistCandidate('{$r.cid}','{$EMP_ID}','{$EMP_JOB_ID}','{$r.t1id}')" class="read-more">
											...
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
												<div class="row">
													<a href="javascript:void(0);" data-toggle="modal"  onclick="addToCart('{$r.cid}','{$EMP_ID}','{$EMP_JOB_ID}','{$r.t1id}');" class="read-more">
													<div class="right-arrow">
														Add to cart
													</div></a>
...
<script>
	...
	function shortlistCandidate(cid, eid, empJobId,avId) {
		var callback = function(res) {
			var response = res.responseText;
			alert(response);
		...
		var url = "admin/application/ajax.php";
		var parameter = "";
		url += "?cid=" + cid +"&eid="+eid+"&emp_job_id="+empJobId+"&av_id="+avId+"&REQUEST=SHORTLIST_CANDIDATES";
		var process = ajax.process(url, parameter);
	}
	...
	function addToCart(cid, eid, empJobId,avId) {
		var callback = function(res) {
			var response = res.responseText;
			alert(response);
			if(response.trim()=="Candidate addedd to cart successfully.")
				window.location.reload();
		};
		var ajax = new Ajax(callback);
		var url = "admin/application/ajax.php";
