	...
	<section class="learning-solution job-info-2" id="benifit" style=" padding-bottom:100px;">
		<div class="container-fluid" style="padding-top:10px;">
			...
			<div class="job-content-2 animated wow fadeIn" data-wow-delay="0.2s">
				...
				<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-xs-12 col-mine-def">
					<div class="content-wrap">
						<div class="company-logo valign-wrap">
							<div class="valign-middle">
								{if $r.profile_pic!=""}
								<img width="81px" height="82px" src="http://skillchamps.in/admin/images/candidate/{$r.uid}/{$r.profile_pic}" alt="">
								{else}
								<img src="http://skillchamps.in/assets/images/individu-1.png" alt="">
								{/if}
							</div>
						</div>
									...
									<div style="margin: 10px 0px 10px 0px;" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="row exp-btn-mine">
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
												<div class="row">
													<a href="javascript:void(0);" data-toggle="modal"  onclick="ShowProfile('{$r.uid}');" class="read-more">
											...
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
												<div class="row">
													<a href="javascript:void(0);" data-toggle="modal"  onclick="ShowDoc('{$r.uid}');" class="read-more">
													<div class="right-arrow">
														Documents
													</div></a>
											...
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
												<div class="row">
													<a href="javascript:void(0);" data-toggle="modal"  onclick="ShowVideo('{$r.uid}');" class="read-more">
													<div class="right-arrow">
														Video
													</div></a>
											...
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
												<div class="row">
													<a href="javascript:void(0);" data-toggle="modal"  onclick="ShowExp('{$r.uid}');" class="read-more">
													<div class="right-arrow">
														Experience
													</div></a>
												</div>
	 ...
	 function ShowProfile(id) {
		...
		var callback = function(res) {
			...
			if (response == "NO") {
				...
				document.getElementById("can_profile_body").innerHTML = response;
				$('#can_profile').modal('show');
			}
		};
		var ajax = new Ajax(callback);
		var url = "admin/application/ajax.php";
		var parameter = "";
		url += "?id=" + id + "&REQUEST=GET_USER_PROFILE";
	...
	function ShowDoc(id) {
		...
		var callback = function(res) {
			...
			if (response == "NO") {
				...
				document.getElementById("doc_body").innerHTML = response;
				$('#view_documents').modal('show');
			}
		};
		var ajax = new Ajax(callback);
		var url = "admin/application/ajax.php";
		var parameter = "";
		url += "?id=" + id + "&REQUEST=GET_USER_DOC";
		var process = ajax.process(url, parameter);
