        ...
        <div class="container">
            ...
            <nav id="myNavbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a class="login-mine" id="shrink_mine" style="width: 120px;" href="index.php?action=register-employer">I Need Staff</a></li>
                </ul>
            </nav>
        </div>
    </header>
...
<br>
		...
		<section class="banner-grey" style="margin-top:-50px;">
			<div class="container sec-hq-pad-t sec-hq-pad-b">
				<h2 style="color: #085658;">Candidate Registration</h2>
			</div>
		</section>
		<!-- Banner Grey Ends -->
		...
		<section class="resume-form sec-hq-pad-t sec-hq-pad-b animated wow fadeIn" data-wow-delay="0.2s" style="background-color:#f8fbfd; padding: 100px 0px; margin-bottom: -65px;">

			<div class="form-content">
				<div class="container">

					<form name="regdfrm" action="index.php?action=save_candidate_registration" class="form-horizontal" method="post">
							...
							<div class="col-md-12 col-sm-12 no-padding ">
								<div class="col-md-12 col-sm-12" >
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="text" name="name" id="name" class="def-input" placeholder="Name*" maxlength="50">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="text" class="def-input"  name="mobile" id="mobile"  placeholder="Mobile*">
										</div>
									</div>
									<div class="form-group">

										<div class="col-md-12">
											<input type="text" class="def-input"   name="aadhaar" id="aadhaar"  placeholder="Aadhar No*">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<select name="jobsector" id="jobsector" onclick="getJobRoleBySector()" class="def-input def-select">
												<option value=""  selected>  Select Job Sector* </option>
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<select name="jobcategory" id="jobcategory" class="def-input def-select">
									...
									<div class="form-group">
										<div class="col-md-4 sec-h-pad-t text-left" style=" padding-top:5px;">
											<a href="javascript:void(0);" class="register_mine" onclick="validateCandidate()">Register</a>
										</div>
									</div>
						...
						<div class="personal-data col-md-4 hiw">
							...
							<h2 style="color: #085658;">How it Works</h2>
							<img src="assets/images/hiw_candidate.png" >
						</div>
